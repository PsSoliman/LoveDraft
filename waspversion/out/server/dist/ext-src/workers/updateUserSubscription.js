export async function updateUserSubscription(_args, context) {
    ...
    const updatedSubscriptions = await Promise.allSettled(expiredUserSubscriptions.map(async (user) => {
        try {
...
//# sourceMappingURL=updateUserSubscription.js.map